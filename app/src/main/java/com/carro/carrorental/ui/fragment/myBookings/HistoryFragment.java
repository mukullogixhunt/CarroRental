...
import com.carro.carrorental.databinding.FragmentHistoryBinding;
 ...
 */
public class HistoryFragment extends BaseFragment implements MyBookingClickListener, SearchPlaceClickListener {
    ...
    private void getBookingApi() {
        ...
        Call<MyBookingsResponse> call = apiInterface.historyBooking(userId);
                ...
                try {
                    if (String.valueOf(response.code()).equalsIgnoreCase(Constant.SUCCESS_RESPONSE_CODE)) {
                        if (response.body().getResult().equalsIgnoreCase(Constant.SUCCESS_RESPONSE)) {
                            ...
                            bookingListAdapter = new BookingListAdapter(getContext(), bookingListModelList,HistoryFragment.this);
                            binding.rvHistory.setAdapter(bookingListAdapter);
    ...
    private void updateBookingBottomDialog() {
        ...
        editBookingDialogBinding.etName.setText(name);
        editBookingDialogBinding.etEmail.setText(email);
        editBookingDialogBinding.etMobile.setText(mobile);
        ...
        editBookingDialogBinding.btnUpdate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String name=editBookingDialogBinding.etName.getText().toString();
                String mobile=editBookingDialogBinding.etMobile.getText().toString();
                String email=editBookingDialogBinding.etEmail.getText().toString();
    ...
    public void onBookingClick(BookingListModel bookingListModel, String type, String bookType) {
        ...
        name= bookingListModel.getmBkingUsername();
        email= bookingListModel.getmBkingUseremail();
        mobile= bookingListModel.getmBkingUsermobile();
