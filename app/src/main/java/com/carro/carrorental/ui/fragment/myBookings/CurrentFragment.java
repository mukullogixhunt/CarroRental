...
import com.carro.carrorental.databinding.FragmentCurrentBinding;
 ...
 */
public class CurrentFragment extends BaseFragment implements MyBookingClickListener, SearchPlaceClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding=FragmentCurrentBinding.inflate(getLayoutInflater());
        getPreferenceData();
    ...
    private void getBookingApi() {
        ...
        binding.rvCurrent.setVisibility(View.GONE);

        ApiInterface apiInterface = ApiClient.getClient().create(ApiInterface.class);
        Call<MyBookingsResponse> call = apiInterface.currentBooking(userId);
                ...
                try {
                    if (String.valueOf(response.code()).equalsIgnoreCase(Constant.SUCCESS_RESPONSE_CODE)) {
                        if (response.body().getResult().equalsIgnoreCase(Constant.SUCCESS_RESPONSE)) {
                            ...
                            binding.rvCurrent.setVisibility(View.VISIBLE);

                            bookingListModelList.clear();
                            bookingListModelList.addAll(response.body().getData());

                            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false);
                            binding.rvCurrent.setLayoutManager(linearLayoutManager);
                            bookingListAdapter = new BookingListAdapter(getContext(), bookingListModelList,CurrentFragment.this);
                            binding.rvCurrent.setAdapter(bookingListAdapter);
...
//        }
        ...
        if (type.equals("emergency_call")){
            openDialer("7566699900");
        }
    }
